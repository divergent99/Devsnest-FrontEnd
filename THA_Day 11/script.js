...
const questions = [
  {
    question: 'What is Vipers Real Name?',
    answers: [
      { text: 'Sabine', correct: true },
  ...
  {
    question: 'Who won the Masters Tournament?',
    answers: [
      { text: 'FNatic', correct: false },
      { text: 'Sentinels', correct: true }
    ]
  }
]
